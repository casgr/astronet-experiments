...
def local_global():
  ...
  config["hparams"]["time_series_hidden"] = {
      "local_view": {
          "cnn_num_blocks": 4, #CNN setup local_view_2 with 16, 32, 64, and 128 feauture map layers
          "cnn_block_size": 2,
          "cnn_initial_num_filters": 16,
          "cnn_block_filter_factor": 2,
          "cnn_kernel_size": 5,
          "convolution_padding": "same",
          "pool_size": 5, #window aangepast naar 5
          "pool_strides": 2,
      },
      "local_view_2": {
          #"cnn_num_blocks": 2, #CNN setup local_view_2 = local_view
          "cnn_num_blocks": 4, #CNN setup local_view_2 with 16, 32, 64, and 128 feauture map layers
          "cnn_block_size": 2,
          "cnn_initial_num_filters": 16,
          "cnn_block_filter_factor": 2,
