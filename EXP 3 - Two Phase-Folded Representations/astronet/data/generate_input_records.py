...
def _process_tce(tce):
  ...
  """
  all_time_1, all_flux_1, all_time_2, all_flux_2 = preprocess.read_light_curve(tce.kepid,
                                                   FLAGS.kepler_data_dir)
  time_1, flux_1, time_2, flux_2 = preprocess.process_light_curve(all_time_1, all_flux_1, all_time_2, all_flux_2)
  return preprocess.generate_example_for_tce(time_1, flux_1, time_2, flux_2, tce)
